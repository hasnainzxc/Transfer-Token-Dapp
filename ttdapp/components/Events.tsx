import { Box, Card, Flex, Heading, Spinner, Text, useBreakpointValue } from "@chakra-ui/react";
...
export default function Events() {
  ...
  return (
    <Box mt={20} width="100%">
      <Heading size="md">Recent Transfer:</Heading>
      {!isEventsLoading ? (
        events?.map((event: any, index) => (
          <Card key={index} my={4} p={cardPadding} borderWidth={1} borderRadius="md">
            <Flex flexDirection="row" alignItems="center">
              <Text p={2} border="1px solid grey" borderRadius={6} fontSize="xs">
